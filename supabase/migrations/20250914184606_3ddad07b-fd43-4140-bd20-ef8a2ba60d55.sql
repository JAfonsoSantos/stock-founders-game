-- Delete the incorrect notification
DELETE FROM notifications WHERE id = '0e5b89ea-1c8b-41dd-9f40-91e387e79483';

-- Create the correct game invitation notification for asantos@kevel.co to join the right "The Unconference" game
