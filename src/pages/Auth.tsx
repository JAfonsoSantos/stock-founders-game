          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <Input
                ...
                className="h-14 text-base bg-background/50 border-border/50 focus:border-primary/50 transition-all duration-200"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              <div className="relative">
                <Input
                  ...
                  className="h-14 text-base pr-12 bg-background/50 border-border/50 focus:border-primary/50 transition-all duration-200"
                  required
                />
                <Button
                  type="button"
            ...
            {authMode === 'magic' && (
              <form onSubmit={handleMagicLink}>
                <Button 
                  type="submit" 
                  className="w-full h-14 text-base font-semibold bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-200" 
            ...
            <div className="space-y-3">
              <Button
                ...
                variant="outline"
                className="w-full h-14 text-base font-medium border-border/50 hover:border-border hover:bg-background/80 transition-all duration-200"
                disabled={loading}
              >
